...
public class PaymentServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("deliver address="+deliverAddress+"mobile:"+mobileNumber+"zipcode"+zipCode);
		...
		try {
		    ...
		    if(rs.next()) {  //account exist
		    	...
		    	if(totalFinalAmount>rs.getInt("balanceAmount")) { //not enough blanace in a/c
		    		...
		    		//update balance in Ecommerce account
		    		...
		    		//update balance in customer account
	   ...
	   /////////////////////////////////////////
			...
			//	SendMail.sendMail(session.getAttribute("customerMailId").toString(), "Invoice orders", content);
				...
				response.sendRedirect("/FullstackEcommerce/OrderHistory.jsp");
